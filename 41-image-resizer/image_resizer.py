...
image_paths = [
    r"C:\AKADEMIE\field.jpg",
    r"C:\AKADEMIE\guy.jpg",
]
"""
...
class ImageResizer2:
    def resize(self, path, *sizes: int):
        """resize into multiple sizes"""
        self.path = path
        self.image = Image.open(path)
...
image_resizer.resize(r"C:\AKADEMIE\field.jpg", 200, 400, 600)
image_resizer.resize(r"C:\AKADEMIE\guy.jpg", 400, 600, 800)
